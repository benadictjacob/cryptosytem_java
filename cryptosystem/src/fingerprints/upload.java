    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                File destination = new File("D:\\" + f.getName() + login.id);
...
//                  finalkey=hkey+"12345678910";
            ...
            try{
            CryptoUtils.encrypt(finalkey.substring(0, 16), f, new File("D:\\" + f.getName() + "enc" + login.id));
//            CipherExample.encrypt(finalkey.substring(0, 16), fis2, fos2);
            } catch (Throwable ex) {
                ex.printStackTrace();
            }
